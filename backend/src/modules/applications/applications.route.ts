...
import { createApplicationSchema, updateApplicationSchema, applicationIdParamSchema, listApplicationsQuerySchema } from "./applications.schema";
...
router.put("/:id", authenticate, validate({ params: applicationIdParamSchema, body: updateApplicationSchema }), update);
