...
export default function LandingFooter() {
  return (
    <footer className="w-full border-t border-[#e8e7e2] bg-[#fcfcfa] text-slate-900">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 py-12 md:flex-row md:items-start md:justify-between">
        <div className="max-w-sm">
          <Link href="/" className="text-lg font-semibold tracking-tight">ApplyFlow</Link>
        ...
        <div className="flex flex-col gap-2 text-sm">
          ...
          <Link href="/register" className="text-slate-500 transition hover:text-slate-900">
            Register
          </Link>
        </div>
      </div>
      ...
      <div className="border-t border-[#e8e7e2]">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-2 px-6 py-6 text-sm text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <p>© {new Date().getFullYear()} ApplyFlow</p>
